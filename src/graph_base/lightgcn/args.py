...
def parse_args():
    ...
    parser.add_argument("--data_dir", default="/home/minseo/Naver_Ai/level2-dkt-recsys-02/data", type=str, help="")
    ...
    parser.add_argument("--patience",default="30",type=int,help="")
